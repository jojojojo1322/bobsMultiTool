...
function assertPacket(packet, snapshot, log, registration) {
  ...
  const requiredFragments = [
    ...
    "If Search Console opens as `task10@ljfriends.net`",
    "If Google AccountChooser or passkey verification blocks `bobob935@gmail.com`",
    "record an account/authentication stop instead of treating it as indexing evidence",
...
function renderPacket(snapshot, log, registration) {
  ...
  return [
    ...
    "- If Search Console opens as `task10@ljfriends.net`, stop the Search Console read, switch/sign in to `bobob935@gmail.com`, and do not record the access-denied page as a page-indexing failure.",
    "- If Google AccountChooser or passkey verification blocks `bobob935@gmail.com`, record an account/authentication stop instead of treating it as indexing evidence.",
    `- Property: \`${searchConsoleProperty}\``,
    `- Sitemaps report: ${searchConsoleSitemapsUrl}`,
    `- Page indexing report: ${searchConsoleIndexUrl}`,
