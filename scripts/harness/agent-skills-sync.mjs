...
const checks = [
  ...
  ["agents", "copyable API response report"],
  ...
  ["agents", "copyable JWT auth report"],
  ...
  ["agents", "copyable Base64 payload report"],
  ...
  ["agents", "copyable Cron schedule report"],
  ...
  ["agents", "copyable Hash signature report"],
  ...
  ["agents", "copyable Password safety report"],
  ["agents", "Random Token Generator must show session/API/CSRF/webhook presets"],
  ["agents", "copyable Random token report"],
  ...
  ["agents", "copyable QR scan report"],
  ...
  ["agents", "YAML deployment report output"],
  ...
  ["agents", "Base64 payload report output"],
  ["agents", "Cron schedule report output"],
  ["agents", "Hash signature report output"],
  ["agents", "Password safety report output"],
  ["agents", "Random Token report output"],
  ["agents", "QR scan report output"],
  ...
  ["agents", "Public HTML/app responses should emit baseline security headers"],
  ...
  ["tool", "Base64 payload report output"],
  ["tool", "Cron schedule report output"],
  ["tool", "Hash signature report output"],
  ["tool", "Password safety report output"],
  ["tool", "Random Token report output"],
  ["tool", "ENV deployment report output"],
  ["tool", "QR scan report output"],
  ["tool", "JWT claim inspection"],
  ["tool", "JWT expected issuer/audience/scope comparison"],
  ["tool", "JWT sensitive-claim redaction"],
  ["product", "JWT auth report output"],
  ["localization", "auth-report labels"],
  ...
  ["tool", "Color accessibility report output"],
  ["tool", "SQL review report output"],
  ["tool", "CSS review report output"],
  ["tool", "JavaScript review report output"],
  ...
  ["design", "copyable API response report"],
  ...
  ["design", "copyable Base64 payload report"],
  ...
  ["design", "copyable Cron schedule report"],
  ...
  ["design", "copyable Hash signature report"],
  ["design", "Password summaries"],
  ["design", "passphrase word count/separator/number controls"],
  ["design", "copyable Password safety report"],
  ["design", "Random Token summaries"],
  ["design", "copyable Random token report"],
  ...
  ["design", "copyable QR scan report"],
  ...
  ["design", "copyable SQL review report"],
  ["design", "copyable CSS review report"],
  ["design", "copyable JavaScript review report"],
  ...
  ["localization", "API response report labels"],
  ...
  ["localization", "YAML deployment report labels"],
  ["localization", "ENV Parser warning/variable-preview labels"],
  ["localization", "ENV deployment report labels"],
  ...
  ["localization", "Base64 payload report labels"],
  ["localization", "Cron preset/field/warning labels"],
  ["localization", "Cron schedule report labels"],
  ...
  ["localization", "Hash signature report labels"],
  ["localization", "Password safety report labels"],
  ["localization", "Random Token report labels"],
  ["localization", "QR scan report labels"],
  ...
  ["localization", "Color accessibility report labels"],
  ["localization", "SQL review report labels"],
  ["localization", "CSS review report labels"],
  ["localization", "JavaScript review report labels"],
  ...
  ["seo", "Public app responses should keep baseline security headers"],
  ...
  ["verification", "copyable API response report"],
  ...
  ["verification", "copyable Base64 payload report"],
  ...
  ["verification", "copyable Cron schedule report"],
  ...
  ["verification", "copyable Hash signature report"],
  ...
  ["verification", "copyable Password safety report"],
  ["verification", "Random Token should show session/API/CSRF/webhook presets"],
  ["verification", "copyable Random token report"],
  ...
  ["verification", "copyable QR scan report"],
  ...
  ["verification", "copyable SQL review report"],
  ["verification", "copyable CSS review report"],
  ["verification", "copyable JavaScript review report"],
  ...
  ["verification", "copyable YAML deployment report"],
  ...
  ["verification", "Route smoke should verify representative HTML responses expose those headers"],
  ...
  ["product", "YAML deployment report output"],
  ["product", "DNS deployment checklist"],
  ["product", "Base64 image/data URL preview"],
  ["product", "Base64 payload report output"],
  ["product", "Cron schedule report output"],
  ["product", "Hash signature report output"],
  ["product", "Password safety report output"],
  ["product", "Random Token report output"],
  ["product", "QR scan report output"],
  ...
  ["product", "JSON Formatter API response report output"],
  ["product", "SQL review report output"],
  ["product", "CSS review report output"],
  ["product", "JavaScript review report output"],
