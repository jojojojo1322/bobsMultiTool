...
const checks = [
  ...
  ["agents", "`json-escape-unescape` is the first approved JSON-cluster breadth addition"],
  ...
  ["product", "`json-escape-unescape` is the first approved JSON-cluster breadth addition"],
  ["product", "YAML Validator"],
  ["product", "CSV Cleaner"],
