...
const checks = [
  ...
  ["agents", "Core acquisition tools need at least two real `inputExamples`"],
  ...
  ["tool", "requiresServer"],
  ["tool", "failure cases"],
  ["tool", "Core acquisition tools need at least two real `inputExamples`"],
  ...
  ["verification", "Core acquisition tools should have at least two real `inputExamples`"],
  ...
  ["product", "Core acquisition tools should have at least two real `inputExamples`"],
