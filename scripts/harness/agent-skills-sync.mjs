...
const checks = [
  ...
  ["agents", "registry-backed `failureCases`, `preCopyChecklist`, and related next actions"],
  ...
  ["product", "70/30 split"],
  ["product", "registry-backed `failureCases`, `preCopyChecklist`, and related next actions"],
