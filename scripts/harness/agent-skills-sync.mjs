...
const checks = [
  ...
  ["agents", "`json-escape-unescape` and `yaml-validator` are approved data/config-cluster breadth additions"],
  ...
  ["product", "`json-escape-unescape` and `yaml-validator` are approved data/config-cluster breadth additions"],
  ["product", "ENV Parser/Validator"],
  ["product", "CSV Cleaner"],
