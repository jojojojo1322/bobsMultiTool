...
for (const fragment of [
  ...
  "유효한 YAML / Docker Compose 진단 / YAML 배포 보고서",
...
for (const fragment of ["localizedYamlReportToolUi", "yamlDeploymentReport", "copyYamlDeploymentReport", "yamlReportEnvValuesExcluded", "YAML 배포 보고서", "YAMLデプロイレポート", "Reporte de despliegue YAML", "YAML-Deployment-Bericht", "تقرير نشر YAML"]) {
  if (!dictionaries.includes(fragment) && !localizedContent.includes(fragment)) failures.push(`localized YAML deployment report content missing fragment: ${fragment}`);
}
...
for (const fragment of [
  ...
  "localizedCssReportToolUi",
  "cssDiagnostics",
  "cssReviewReport",
  "copyCssReviewReport",
  "cssReportChecklistCascade",
  "customProperties",
  "colorTokens",
  "compressionRatio",
  "selectorPreview",
  ...
  "localizedJavaScriptReportToolUi",
  "jsReviewReport",
  "copyJsReviewReport",
  "jsReportChecklistRuntime",
  ...
  "localizedSecurityHeaderReportToolUi",
  "localizedHttpIndexabilityToolUi",
  ...
  "copySecurityHeaderReport",
  "securityHeaderReportChecklistCsp",
  "indexabilitySignals",
  "indexabilityNoindexWarning",
  "색인 요청 준비됨",
  "インデックスリクエスト準備済み",
  "Listo para pedir indexacion",
  "Bereit fuer Indexierungsanfrage",
  "إشارات قابلية الفهرسة",
  "hstsHeaderDetail",
