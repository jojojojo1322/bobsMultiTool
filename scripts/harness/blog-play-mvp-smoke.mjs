...
for (const entry of playEntries.filter((item) => item.type === "arcade-game")) {
  const isEndlessLotteryArcade = entry.arcade?.variant === "lottery" || entry.arcade?.variant === "lottery-economy";
