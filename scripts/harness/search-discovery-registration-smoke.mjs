...
for (const fragment of [
  ...
  "Latest `2026-07-07` browser recheck still reached the public Bing Webmaster Tools about/landing page with `Sign In`",
  "Public Bing search",
  "Latest browser check hit a `계속하려면 아래 과제 해결` challenge",
  "Naver Search Advisor",
  "Latest `2026-07-07` signed-in Search Advisor recheck reached the `풀꽃` account dashboard",
