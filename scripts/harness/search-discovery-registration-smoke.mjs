...
for (const fragment of [
  ...
  `Search Console sitemap visible row after ${latestExternalSitemapCount}-URL resubmission: \`/sitemaps/en\`, submitted \`2026. 7. 6.\`, last read \`2026. 7. 6.\`, status \`성공\`, discovered pages \`${latestExternalSitemapCount}\`, discovered videos \`0\`.`,
