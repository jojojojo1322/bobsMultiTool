...
for (const fragment of [
  ...
  "Post-pruning pillar live tests for `why-bobob-shifted-to-content-lab` and `content-indexing-checklist-before-resubmission` both returned `URL을 Google에 등록할 수 있음`",
  "Bing and IndexNow",
