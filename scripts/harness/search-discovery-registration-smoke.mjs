...
for (const fragment of [
  ...
  `Current reduced sitemap target: \`${expectedSitemapUrlCount}\` URLs`,
  "Search Console showed `사이트맵이 제출됨`",
  "submitted `2026. 7. 3.`, last read `2026. 7. 3.`, status `성공`, discovered pages `73`, videos `0`",
  `has discovered all \`${expectedSitemapUrlCount}\` current sitemap URLs yet`,
  ...
  "Bing and IndexNow",
  `Current IndexNow representative target: \`${expectedSitemapUrlCount}\` URLs`,
  ...
  "JSON Feed",
  "WebSub",
  `Current WebSub/feed target: \`${expectedFeedItemCount}\` RSS items and \`${expectedFeedItemCount}\` Atom entries`,
  "robots.txt",
  "OpenSearch",
  "llms.txt",
