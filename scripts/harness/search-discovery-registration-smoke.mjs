...
for (const fragment of [
  ...
  `Current reduced source sitemap target: \`${expectedSitemapUrlCount}\` URLs`,
  "latest signed-in Search Console observation is still the prior live 76-URL deployment",
  "submitted `2026. 7. 3.`, last read `2026. 7. 3.`, status `성공`, discovered pages `76`, videos `0`",
  "Google accepted, read, and discovered the previous 76-URL canonical sitemap set",
  ...
  "Pillar URL inspections: `why-bobob-shifted-to-content-lab` and `content-indexing-checklist-before-resubmission` are still not indexed",
  "both have `색인 생성 요청됨` confirmations",
  "Bing and IndexNow",
  `the new ${expectedSitemapUrlCount}-URL source target has not been submitted yet`,
  ...
  "Signed-in Search Advisor showed `https://www.bobob.app` owned under `풀꽃`",
  "`사이트맵을 찾을 수 없습니다`",
  "`sitemaps/en` was not visibly added after submission attempts",
  "RSS feed",
  "Atom feed",
  "JSON Feed",
  "WebSub",
  `Current representative feed source target has \`${expectedFeedItemCount}\` Blog + Play items`,
  `the new ${expectedFeedItemCount}-item feed target has not been published yet`,
  "robots.txt",
  "OpenSearch",
  "llms.txt",
