...
for (const fragment of [
  ...
  "Latest `bobob935@gmail.com` resubmission confirmed `사이트맵이 제출됨`; submitted/read `2026. 6. 26.`, status `성공`, discovered pages `68`, matching the live XML count",
  ...
  "Bing and IndexNow",
  "Latest response status `200`; submitted URL count `68` after the arcade Play deployment",
  ...
  "JSON Feed",
  "WebSub",
  "Latest publish responses `204`, `204` with feed item counts `58`, `58`",
  "robots.txt",
  "OpenSearch",
  "llms.txt",
