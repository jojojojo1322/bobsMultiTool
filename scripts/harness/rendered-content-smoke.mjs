...
const paths = [
  { path: "/", kind: "home", minChars: 5000 },
  { path: "/tools", kind: "directory", minChars: 5000 },
  ...toolSlugs.map((slug) => ({ path: `/tools/${slug}`, kind: "tool", minChars: 3800 })),
  { path: "/guides", kind: "guide-index", minChars: 4000 },
  ...guideSlugs.map((slug) => ({ path: `/guides/${slug}`, kind: "guide", minChars: 4500 })),
  { path: "/about", kind: "trust", minChars: 3000 },
  { path: "/contact", kind: "trust", minChars: 3000 },
  { path: "/privacy", kind: "legal", minChars: 3600 },
  { path: "/terms", kind: "legal", minChars: 3600 },
  ...locales.flatMap((locale) => [
    { path: `/${locale}/tools`, kind: "localized-directory", minChars: 5000 },
    { path: `/${locale}/tools/json-formatter`, kind: "localized-tool", minChars: 3500 },
    ...guideSlugs.map((slug) => ({ path: `/${locale}/guides/${slug}`, kind: "localized-guide", minChars: 3800 })),
    { path: `/${locale}/about`, kind: "localized-trust", minChars: 3600 },
    { path: `/${locale}/contact`, kind: "localized-trust", minChars: 3600 },
    { path: `/${locale}/privacy`, kind: "localized-legal", minChars: 3600 },
    { path: `/${locale}/terms`, kind: "localized-legal", minChars: 3600 },
  ]),
];
