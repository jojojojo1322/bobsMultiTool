...
for (const intent of ["api response formatter", "api response report", "json response report", "api error report", "json error line column", "json parse error context", "json field extractor", "json path extractor", "recursive jsonpath", "sql review report", "sql query review report", "sql mutation checklist", "sql where clause report", "sql handoff report", "css review report", "css selector report", "css cascade checklist", "css specificity checker", "css handoff report", "javascript review report", "js snippet risk report", "javascript fetch checklist", "javascript eval checker", "javascript handoff report", "jwt exp checker", "jwt authorization header", "jwt sensitive claims", "jwt redacted payload", "jwt issuer checker", "jwt audience checker", "jwt scope checker", "jwt auth report", "api token handoff report", "token auth report", "password handoff report", "password safety report", "password compatibility report", "passphrase report", "temporary password report", "credential handoff report", "secure token report", "token handoff report", "csrf token report", "api key seed report", "base64 payload report", "base64 decode report", "base64 json report", "hash signature report", "hmac handoff report", "hmac verification report", "color accessibility report", "wcag contrast report", "design token contrast report", "redirect chain checker", "canonical redirect checker", "apex to www redirect", "www redirect checker", "308 redirect checker", "http to https redirect checker", "cache-control checker", "etag checker", "304 not modified checker", "cdn cache checker", "stale cache after deploy", "x-vercel-cache", "cf-cache-status", "캐시 헤더 확인", "배포 후 캐시 확인", "redirect loop checker", "too many redirects checker", "search console redirect page", "page with redirect", "리디렉션이 포함된 페이지", "www 리디렉션 확인", "308 리디렉션 확인", "리디렉션 루프 점검", "site indexing checklist", "google indexing checker", "search console sitemap", "search console update delay", "search console last updated", "search console wrong google account", "search console property access denied", "search console not verified property", "search console account mismatch", "search console passkey verification", "search console identity verification", "search console page indexing last updated", "page indexing report date not changing", "sitemap last read vs page indexing", "url inspection indexed but report not updated", "search console report refresh lag", "indexnow submitted but not indexed", "indexnow 200 not indexing proof", "bing webmaster sign in blocked", "bing webmaster recommendations not visible", "bing site search challenge", "webmaster sitemap accepted but not indexed", "search discovery report", "sitemap indexing check", "sitemap submission report", "robots crawl report", "robots txt report", "crawl policy report", "meta crawler report", "seo meta report", "social preview report", "open graph crawler report", "link preview qa report", "url canonical report", "clean url report", "utm cleanup report", "canonical url mismatch", "duplicate canonical checker", "search console duplicate canonical", "duplicate without user-selected canonical", "alternate page with proper canonical tag", "google chose different canonical", "google selected canonical", "user selected canonical", "표준 URL 불일치", "중복 표준 URL 확인", "사용자가 선택한 표준이 없는 중복 페이지", "적절한 표준 태그가 포함된 대체 페이지", "robots canonical check", "search discovery checklist", "naver search advisor sitemap", "naver search advisor collection status", "naver sitemap not found", "naver sitemap row not visible", "naver old sitemap rows", "search advisor sitemap not found", "search advisor old sitemap rows", "Search Console 계정 다름", "Search Console 속성 액세스 거부", "이 속성에 액세스할 수 없습니다", "서치콘솔 계정 확인", "Search Console 패스키 확인", "Search Console 본인 확인", "본인 확인 중", "패스키를 사용하여 로그인을 완료합니다", "Bing Webmaster 로그인 필요", "Bing site 검색 챌린지", "IndexNow 제출 색인 아님", "IndexNow 200 색인 증거 아님", "네이버 서치어드바이저 사이트맵", "네이버 서치어드바이저 수집 상태", "사이트맵을 찾을 수 없습니다", "네이버 사이트맵 행 안 보임", "네이버 오래된 사이트맵 행", "Search Console 색인 업데이트", "페이지 색인 생성 최종 업데이트", "색인 리포트 언제 업데이트", "크롤링됨 - 현재 색인이 생성되지 않음", "크롤링됨 현재 색인이 생성되지 않음", "크롤링은 됐는데 색인 안됨", "크롤링 색인 실패", "크롤링과 색인 실패", "크롤링 색인 모두 실패", "크롤링, 색인 모두 실패", "색인 생성 실패", "색인 리포트 날짜 안 바뀜", "사이트맵 읽음 색인 리포트 지연", "URL 검사 등록됨 리포트 미반영", "crawled currently not indexed", "discovered currently not indexed", "page indexing report", "page indexing report not updated", "page indexing report refresh", "when does search console update", "url inspection request", "indexing request queued", "indexing observation log", "not indexed after crawl", "googlebot final 200", "indexable url checker", "색인 대체 언제 업데이트", "base64 image decoder", "download base64 image", "data url decoder", "dns propagation checklist", "dns deployment checker", "dns deployment checklist", "dns deployment report", "domain dns report", "dmarc checker", "name server checker", "wifi qr code generator", "qr quiet zone", "qr scan report", "qr print checklist", "wifi qr scan report", "csrf token generator", "security headers checker", "security response header checker", "security header report", "http security report", "csp review report", "hsts report", "hsts checker", "referrer policy checker", "content security policy generator", "cors header checker", "cors preflight checker", "cors error devtools", "fetch cors error", "preflight request failed", "access control allow origin checker", "access-control-allow-origin", "cors credentials wildcard", "CORS 오류 확인", "프리플라이트 요청 실패", "Access-Control-Allow-Origin 확인", "CORS credentials 점검", "docker compose validator", "docker compose yaml validator", "docker compose report", "compose deployment report", "yaml deployment report", "deployment config checker", "deploy config validator", "deployment config report", "vercel environment variables", "vercel env checker", "production env checker", "missing env variable deploy", "배포 설정 점검", "환경변수 누락 확인", "도커 컴포즈 검증", "도커 컴포즈 보고서", "YAML 배포 보고서", "csv cleaner", "markdown table generator"]) {
...
for (const intent of ["search discovery report", "sitemap submission report", "search console sitemap report", "page indexing report", "page indexing report not updated", "search console wrong google account", "search console property access denied", "search console not verified property", "search console account mismatch", "search console passkey verification", "search console identity verification", "search console page indexing last updated", "page indexing report date not changing", "sitemap last read vs page indexing", "url inspection indexed but report not updated", "search console report refresh lag", "indexnow submitted but not indexed", "indexnow 200 not indexing proof", "bing webmaster sign in blocked", "bing webmaster recommendations not visible", "bing site search challenge", "webmaster sitemap accepted but not indexed", "url inspection evidence", "indexing observation log", "crawled currently not indexed", "discovered currently not indexed", "search console update delay", "search console last updated", "duplicate without user-selected canonical", "alternate page with proper canonical tag", "canonical sitemap checker", "submitted url canonical check", "Search Console 계정 다름", "Search Console 속성 액세스 거부", "이 속성에 액세스할 수 없습니다", "서치콘솔 계정 확인", "Search Console 패스키 확인", "Search Console 본인 확인", "본인 확인 중", "패스키를 사용하여 로그인을 완료합니다", "크롤링됨 - 현재 색인이 생성되지 않음", "크롤링됨 현재 색인이 생성되지 않음", "크롤링은 됐는데 색인 안됨", "크롤링 색인 실패", "크롤링과 색인 실패", "크롤링 색인 모두 실패", "크롤링, 색인 모두 실패", "색인 생성 실패", "사용자가 선택한 표준이 없는 중복 페이지", "적절한 표준 태그가 포함된 대체 페이지", "색인 리포트 언제 업데이트", "페이지 색인 생성 최종 업데이트", "색인 리포트 날짜 안 바뀜", "사이트맵 읽음 색인 리포트 지연", "URL 검사 등록됨 리포트 미반영", "Bing Webmaster 로그인 필요", "Bing site 검색 챌린지", "IndexNow 제출 색인 아님", "IndexNow 200 색인 증거 아님", "naver search advisor sitemap", "naver search advisor collection status", "naver sitemap not found", "naver sitemap row not visible", "naver old sitemap rows", "search advisor sitemap not found", "search advisor old sitemap rows", "네이버 서치어드바이저 사이트맵", "네이버 서치어드바이저 수집 상태", "사이트맵을 찾을 수 없습니다", "네이버 사이트맵 행 안 보임", "네이버 오래된 사이트맵 행"]) {
...
for (const intent of ["cache-control checker", "cache header checker", "etag checker", "304 not modified checker", "cdn cache checker", "browser cache checker", "stale cache after deploy", "x-vercel-cache", "cf-cache-status", "cloudflare cache status", "vercel cache header", "캐시 헤더 확인", "304 확인", "배포 후 캐시 확인", "CDN 캐시 확인", "브라우저 캐시 확인"]) {
  if (!workflows.includes(intent)) failures.push(`redirect workflow cache/CDN intent missing ${intent}`);
  if (!registry.includes(intent)) failures.push(`HTTP Status Checker cache/CDN search surface missing ${intent}`);
}
...
for (const intent of ["meta crawler report", "seo meta report", "social preview report", "open graph crawler report", "link preview qa report", "indexable metadata check", "noindex metadata checker", "canonical metadata report", "canonical tag checker", "user selected canonical", "google selected canonical", "alternate page with proper canonical tag", "duplicate without user-selected canonical", "적절한 표준 태그가 포함된 대체 페이지", "사용자가 선택한 표준이 없는 중복 페이지"]) {
  if (!registry.includes(intent)) failures.push(`Meta Tag Generator registry search surface missing ${intent}`);
}
for (const intent of ["url canonical report", "clean url report", "utm cleanup report", "canonical url mismatch", "search console duplicate canonical", "inspected url canonical check", "duplicate without user-selected canonical", "alternate page with proper canonical tag", "google chose different canonical", "google selected canonical", "user selected canonical", "duplicate canonical checker", "표준 URL 불일치", "중복 표준 URL 확인", "사용자가 선택한 표준이 없는 중복 페이지", "적절한 표준 태그가 포함된 대체 페이지"]) {
...
for (const intent of ["stale cache after deploy", "deployment cache checker", "cdn cache checker", "cloudflare cache status", "vercel cache header", "x-vercel-cache", "cf-cache-status", "배포 후 캐시 확인", "CDN 캐시 확인"]) {
  if (!workflows.includes(intent)) failures.push(`deploy config cache/CDN workflow intent missing ${intent}`);
}
...
for (const intent of ["docker compose validator", "compose yaml validator", "docker compose yaml validator", "docker compose report", "compose deployment report", "yaml deployment report", "yaml config checker", "deployment yaml checker", "deploy config validator", "도커 컴포즈 검증", "도커 컴포즈 보고서", "YAML 배포 보고서"]) {
