...
for (const fragment of ["data-http-status-details", "data-http-redirect-chain", "data-http-redirect-diagnostics", "data-http-response-headers", "data-http-indexability", "data-public-url-report", "data-public-url-report-preview", "buildPublicUrlReport", "getHttpIndexabilityDiagnostics", "indexability", "canonicalHref", "canonicalMatchesFinal", "h1Count", "htmlLang", "data-http-header-parser", "data-http-header-summary", "data-http-security-readiness", "data-http-security-checklist", "data-http-security-report", "data-http-security-report-copy", "data-http-security-report-preview", "buildSecurityHeaderReport", "getSecurityHeaderChecks", "formatHttpStatusError", "presentSecurityHeaders", "missingRequiredSecurityHeaders", "data-http-header-warnings", "data-http-header-json", "data-csp-generator", "data-csp-directives", "data-csp-warnings", "data-csp-output", "rawResponse", "finalResponseHeaders", "elapsedMs", "cacheControl", "autoCheckUrlParamRef", "URLSearchParams(window.location.search).get(\"url\")", "void check(nextUrl)"]) {
...
if (!dictionaries.includes("localizedSecurityHeaderReportToolUi") || !dictionaries.includes("copySecurityHeaderReport")) failures.push("security header report labels must be localized");
...
if (!dictionaries.includes("localizedHttpIndexabilityToolUi") || !dictionaries.includes("indexabilitySignals")) failures.push("HTTP indexability labels must be localized");
