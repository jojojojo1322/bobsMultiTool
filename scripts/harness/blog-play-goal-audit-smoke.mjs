...
for (const fragment of [
  ...
  `The ${currentSubmittedSitemapCount}-URL representative sitemap set has been submitted to IndexNow with response status \`200\``,
  ...
  "visible `/sitemaps/en` row still shows a stale broad-set count-column value `151`",
