...
const commonText: Record<Locale, CommonLocaleOverride> = {
  ...
  hi: {
    ...
    home: { badge: "डेवलपर वर्कबेंच", title: "रोजमर्रा के developer workflows के लिए व्यावहारिक browser tools.", description: "Payload format करें, patterns test करें, tokens inspect करें, metadata बनाएं, text compare करें और values convert करें.", openTools: "टूल खोलें", readGuides: "गाइड पढ़ें", toolIndexTitle: "टूल इंडेक्स", toolIndexDescription: "SEO, navigation, locale और validation से जुड़ी registry utilities." },
    tool: { developerWorkbench: "डेवलपर वर्कबेंच", singleDomainTitle: "एक domain", singleDomainBody: "सारे tools www.bobob.app के नीचे हैं ताकि AdSense review और search authority साफ रहे.", localFirstTitle: "Local-first", localFirstBody: "Formatting, decoding और generation जहां practical हो browser में चलती है.", expandableRegistryTitle: "बढ़ने योग्य registry", expandableRegistryBody: "नए tools में metadata, locale support, examples, FAQ, guides, related links और smoke checks जरूरी हैं.", examplesDescription: "इस utility के शुरुआती उदाहरण", faqDescription: "आम implementation details", guidesDescription: "इस tool से जुड़े workflows", useCases: "उपयोग के मामले", copy: "कॉपी", copied: "कॉपी हो गया", privacy: "Privacy", serverRequired: "Server route", localOnly: "Browser local" },
  ...
  ar: {
    ...
    tool: { developerWorkbench: "منضدة المطور", singleDomainTitle: "نطاق واحد", singleDomainBody: "كل الأدوات تحت www.bobob.app لمراجعة AdSense أوضح وسلطة بحث أقوى.", localFirstTitle: "محلي أولا", localFirstBody: "التنسيق وفك الترميز والإنشاء تعمل في المتصفح كلما أمكن.", expandableRegistryTitle: "Registry قابل للتوسع", expandableRegistryBody: "كل أداة جديدة تحتاج metadata وlocale وأمثلة وFAQ وأدلة وروابط مرتبطة وsmoke checks.", examplesDescription: "نقاط بداية لهذه الأداة", faqDescription: "تفاصيل تنفيذ شائعة", guidesDescription: "سير عمل مرتبط بهذه الأداة", useCases: "حالات الاستخدام", copy: "نسخ", copied: "تم النسخ", privacy: "الخصوصية", serverRequired: "route خادم", localOnly: "محلي في المتصفح" },
