...
const commonText: Record<Locale, CommonLocaleOverride> = {
  ...
  vi: {
    ...
    home: { badge: "Ban lam viec lap trinh", title: "Cong cu trinh duyet thuc dung cho viec lap trinh hang ngay.", description: "Dinh dang du lieu, thu mau, kiem tra token, tao sieu du lieu, so sanh van ban va chuyen doi gia tri trong mot domain.", openTools: "Mo cong cu", readGuides: "Doc huong dan", toolIndexTitle: "Danh muc cong cu", toolIndexDescription: "Tien ich dang ky ket noi SEO, dieu huong, ngon ngu va kiem thu." },
    tool: { developerWorkbench: "Ban lam viec lap trinh", singleDomainTitle: "Mot domain", singleDomainBody: "Tat ca cong cu nam duoi www.bobob.app de review AdSense ro rang hon va tang suc manh tim kiem.", localFirstTitle: "Uu tien cuc bo", localFirstBody: "Dinh dang, giai ma va tao du lieu chay trong trinh duyet khi co the.", expandableRegistryTitle: "Danh muc mo rong", expandableRegistryBody: "Cong cu moi can sieu du lieu, ngon ngu, vi du, FAQ, huong dan, link lien quan va kiem tra nhanh.", examplesDescription: "Diem bat dau cho cong cu nay", faqDescription: "Chi tiet trien khai thuong gap", guidesDescription: "Quy trinh lien quan toi cong cu nay", useCases: "Truong hop dung", copy: "Sao chep", copied: "Da sao chep", privacy: "Rieng tu", serverRequired: "Kiem tra server", localOnly: "Cuc bo tren trinh duyet" },
    guides: { badge: "Huong dan", title: "Huong dan thuc te cho tien ich trinh duyet", description: "Bai viet ngan giai thich quy trinh phia sau cong cu.", back: "Quay lai huong dan", relatedTitle: "Cong cu lien quan", relatedDescription: "Mo tien ich lien ket voi huong dan nay." },
...
const dictionaryOverrides: Partial<Record<Locale, CommonLocaleOverride>> = {
  ...
  hi: {
    siteDescription: "Data format, encoding, testing, conversion, SEO, network, color, time aur text kaam ke liye muft developer upkaran.",
    metadata: {
      homeTitle: "Bob's Multi Tool - व्यावहारिक डेवलपर यूटिलिटी",
      homeDescription: "JSON, regex, Base64, JWT, cron, timestamp, UUID, SEO, color, network aur text ke liye muft online developer upkaran.",
      toolDescription: (title) => `${title} Bob's Multi Tool par. Udaharan, FAQ, sambandhit upkaran aur jahaan sambhav ho browser-local privacy ke sath tez utility.`,
      guideDescription: (title) => `${title}. Browser-based developer upkaran ko surakshit aur prabhavi tarike se istemal karne ki practical guide.`,
    },
  },
  id: {
