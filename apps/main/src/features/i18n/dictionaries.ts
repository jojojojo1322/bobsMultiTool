...
const commonText: Record<Locale, CommonLocaleOverride> = {
  ...
  "pt-BR": {
    ...
    tool: { developerWorkbench: "Workbench de desenvolvimento", singleDomainTitle: "Dominio unico", singleDomainBody: "Todas as ferramentas ficam em www.bobob.app para revisao do AdSense mais clara e autoridade de busca concentrada.", localFirstTitle: "Local primeiro", localFirstBody: "Formatacao, decodificacao e geracao rodam no navegador sempre que pratico.", expandableRegistryTitle: "Registry expansivel", expandableRegistryBody: "Cada ferramenta precisa de metadata, locale, exemplos, FAQ, guias, links relacionados e smoke checks.", examplesDescription: "Pontos de partida para esta utilidade", faqDescription: "Detalhes comuns de implementacao", guidesDescription: "Fluxos conectados a esta ferramenta", useCases: "Casos de uso", copy: "Copiar", copied: "Copiado", privacy: "Privacidade", serverRequired: "Rota de servidor", localOnly: "Local no navegador" },
  ...
  fr: {
    ...
    home: { badge: "Atelier developpeur", title: "Outils navigateur pratiques pour les workflows developpeur quotidiens.", description: "Formatez des donnees, testez des motifs, inspectez des tokens, generez des metadonnees, comparez du texte et convertissez des valeurs sur un seul domaine.", openTools: "Ouvrir les outils", readGuides: "Lire les guides", toolIndexTitle: "Index des outils", toolIndexDescription: "Utilitaires relies au SEO, a la navigation, aux locales et aux validations." },
    tool: { developerWorkbench: "Atelier developpeur", singleDomainTitle: "Domaine unique", singleDomainBody: "Tous les outils vivent sous www.bobob.app pour une revue AdSense plus claire et une meilleure autorite de recherche.", localFirstTitle: "Local d'abord", localFirstBody: "Formatage, decodage et generation tournent dans le navigateur quand c'est possible.", expandableRegistryTitle: "Registry extensible", expandableRegistryBody: "Chaque outil demande metadata, locale, exemples, FAQ, guides, liens lies et smoke checks.", examplesDescription: "Points de depart pour cet outil", faqDescription: "Details d'implementation courants", guidesDescription: "Workflows lies a cet outil", useCases: "Cas d'utilisation", copy: "Copier", copied: "Copie", privacy: "Confidentialite", serverRequired: "Route serveur", localOnly: "Local navigateur" },
  ...
  hi: {
    ...
    home: { badge: "डेवलपर वर्कबेंच", title: "रोजमर्रा के डेवलपर कामों के लिए व्यावहारिक ब्राउज़र टूल.", description: "Payload format करें, pattern test करें, token जांचें, metadata बनाएं, text compare करें और value convert करें.", openTools: "टूल खोलें", readGuides: "गाइड पढ़ें", toolIndexTitle: "टूल इंडेक्स", toolIndexDescription: "SEO, navigation, locale और validation से जुड़ी registry utilities." },
    tool: { developerWorkbench: "डेवलपर वर्कबेंच", singleDomainTitle: "एक domain", singleDomainBody: "सारे tools www.bobob.app के नीचे हैं ताकि AdSense review और search authority साफ रहे.", localFirstTitle: "लोकल पहले", localFirstBody: "Formatting, decoding और generation जहां practical हो browser में चलती है.", expandableRegistryTitle: "बढ़ने योग्य registry", expandableRegistryBody: "नए tools में metadata, locale support, examples, FAQ, guides, related links और smoke checks जरूरी हैं.", examplesDescription: "इस utility के शुरुआती उदाहरण", faqDescription: "आम implementation details", guidesDescription: "इस tool से जुड़े workflows", useCases: "उपयोग के मामले", copy: "कॉपी", copied: "कॉपी हो गया", privacy: "गोपनीयता", serverRequired: "सर्वर जांच", localOnly: "ब्राउज़र में लोकल" },
    guides: { badge: "गाइड", title: "Browser utilities के व्यावहारिक गाइड", description: "छोटे support articles जो tools के workflow समझाते हैं.", back: "गाइड पर वापस", relatedTitle: "संबंधित टूल", relatedDescription: "इस guide से जुड़ी utility खोलें." },
  ...
  id: {
    ...
    tool: { developerWorkbench: "Workbench developer", singleDomainTitle: "Domain tunggal", singleDomainBody: "Semua tool berada di www.bobob.app agar review AdSense lebih jelas dan otoritas pencarian terkumpul.", localFirstTitle: "Lokal lebih dulu", localFirstBody: "Formatting, decoding, dan generation berjalan di browser bila memungkinkan.", expandableRegistryTitle: "Registry yang bisa diperluas", expandableRegistryBody: "Tool baru wajib punya metadata, locale, contoh, FAQ, panduan, link terkait, dan smoke check.", examplesDescription: "Titik awal untuk utilitas ini", faqDescription: "Detail implementasi umum", guidesDescription: "Workflow yang terhubung", useCases: "Kasus penggunaan", copy: "Salin", copied: "Tersalin", privacy: "Privasi", serverRequired: "Cek server", localOnly: "Lokal di browser" },
  ...
  ar: {
    ...
    tool: { developerWorkbench: "منضدة المطور", singleDomainTitle: "نطاق واحد", singleDomainBody: "كل الأدوات تحت www.bobob.app لمراجعة AdSense أوضح وسلطة بحث أقوى.", localFirstTitle: "محلي أولا", localFirstBody: "التنسيق وفك الترميز والإنشاء تعمل في المتصفح كلما أمكن.", expandableRegistryTitle: "Registry قابل للتوسع", expandableRegistryBody: "كل أداة جديدة تحتاج metadata وlocale وأمثلة وFAQ وأدلة وروابط مرتبطة وsmoke checks.", examplesDescription: "نقاط بداية لهذه الأداة", faqDescription: "تفاصيل تنفيذ شائعة", guidesDescription: "سير عمل مرتبط بهذه الأداة", useCases: "حالات الاستخدام", copy: "نسخ", copied: "تم النسخ", privacy: "الخصوصية", serverRequired: "فحص عبر الخادم", localOnly: "محلي في المتصفح" },
...
const dictionaryOverrides: Partial<Record<Locale, CommonLocaleOverride>> = {
  ...
  hi: {
    siteDescription: "Formatting, encoding, testing, conversion, SEO, network, color, time और text workflows के लिए मुफ्त developer tools.",
    metadata: {
      homeTitle: "Bob's Multi Tool - व्यावहारिक developer utilities",
      homeDescription: "JSON, regex, Base64, JWT, cron, timestamps, UUID, SEO, color, network और text के लिए मुफ्त online developer tools.",
      toolDescription: (title) => `${title} Bob's Multi Tool पर. उदाहरण, FAQ, related tools और जहां संभव हो local-first privacy के साथ तेज utility.`,
      guideDescription: (title) => `${title}. Browser-based developer utilities को सुरक्षित और प्रभावी ढंग से इस्तेमाल करने की practical guide.`,
    },
  },
  id: {
  ...
  th: {
    siteDescription: "เครื่องมือ developer ฟรีสำหรับ formatting, encoding, testing, conversion, SEO, network, color, time และ text workflows.",
    metadata: {
      homeTitle: "Bob's Multi Tool - เครื่องมือ developer ที่ใช้งานจริง",
      homeDescription: "เครื่องมือฟรีสำหรับ JSON, regex, Base64, JWT, cron, timestamps, UUID, SEO, color, network และ text.",
      toolDescription: (title) => `${title} ใน Bob's Multi Tool พร้อมตัวอย่าง FAQ เครื่องมือที่เกี่ยวข้อง และ local-first privacy เมื่อทำได้.`,
      guideDescription: (title) => `${title}. คู่มือใช้งาน browser developer utilities อย่างปลอดภัยและมีประสิทธิภาพ.`,
    },
  },
  ar: {
    dir: "rtl",
    ...
    metadata: {
      ...
      toolDescription: (title) => `${title} في Bob's Multi Tool مع أمثلة وFAQ وأدوات مرتبطة وخصوصية local-first عندما يكون ذلك ممكنا.`,
