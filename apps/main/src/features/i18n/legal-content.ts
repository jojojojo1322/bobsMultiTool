  ...
  hi: {
    privacy: {
      ...
      sections: [
        ...
        { heading: "विश्लेषण और विज्ञापन", body: "साइट Google Analytics और Google AdSense का उपयोग कर सकती है. ये तृतीय-पक्ष सेवाएं अपनी नीतियों के अनुसार कुकी या मिलती-जुलती तकनीकें इस्तेमाल कर सकती हैं." },
      ],
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: "विज्ञापन", body: "मंजूरी के बाद साइट Google AdSense विज्ञापन दिखा सकती है. विज्ञापन सामग्री तृतीय-पक्ष नेटवर्क से दी जाती है और उनकी नीतियों के अनुसार वैयक्तिकृत हो सकती है." },
      ],
  ...
  th: {
    privacy: {
      ...
      sections: [
        ...
        { heading: "การวิเคราะห์และโฆษณา", body: "เว็บไซต์อาจใช้ Google Analytics และ Google AdSense บริการภายนอกเหล่านี้อาจใช้คุกกี้หรือเทคโนโลยีใกล้เคียงตามนโยบายของตนเอง" },
      ],
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: "โฆษณา", body: "หลังได้รับอนุมัติ เว็บไซต์อาจแสดงโฆษณา Google AdSense เนื้อหาโฆษณามาจากเครือข่ายภายนอกและอาจถูกปรับให้เหมาะตามนโยบายของบริการนั้น" },
      ],
