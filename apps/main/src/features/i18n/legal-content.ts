  ...
  vi: {
    privacy: {
      ...
      sections: [
        ...
        { heading: "Kiem tra qua server", body: "Cong cu HTTP status va DNS can endpoint server nho vi trinh duyet khong the tu thuc hien truc tiep. Khong gui hostname noi bo rieng tu hoac du lieu bao mat." },
