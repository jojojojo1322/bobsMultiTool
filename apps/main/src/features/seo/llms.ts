...
export function llmsTxt() {
  return [
    "# bobob.app",
    "",
    "> 개발/AI 기록과 플래시게임처럼 바로 해보는 가벼운 Play를 일단 만들어 보는 정적 웹 작업장입니다.",
    "",
    "bobob.app은 개발자 도구 보관소에서 Blog + Play 중심의 작은 작업장으로 전환 중입니다. 글은 실제 개발, AI 활용, 사이드 프로젝트 운영 판단을 다루고, Play는 단일 규칙과 짧은 조작으로 끝나는 정적 웹 놀이입니다.",
    "",
    "## Core",
