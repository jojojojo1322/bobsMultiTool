...
export const metadata: Metadata = {
  ...
  description: "카드 하나 골라 바로 시작하는 bobob.app의 작은 웹게임 목록입니다. 마우스와 키보드로 짧게 한 판 하고 결과를 봅니다.",
  ...
  openGraph: {
    ...
    siteName: "bobob.app",
    title: "Play - bobob.app",
    description: "카드 하나 골라 바로 시작합니다. 마우스로 누르고, 방향키로 움직이고, 끝나면 점수만 보면 됩니다.",
    images: [playShareImage],
  },
  twitter: {
    card: "summary_large_image",
    title: "Play - bobob.app",
    description: "카드 하나 골라 바로 시작합니다. 마우스와 키보드로 짧게 한 판씩 해봅니다.",
    ...
    <main className="min-h-screen bg-background" lang={contentLocale} dir={dictionary.dir}>
      ...
      <section className="border-b bg-muted/20">
        <div className="mx-auto max-w-6xl px-4 py-10">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
            카드 하나 골라 바로 시작하면 됩니다. 마우스로 누르고, 방향키로 움직이고, 끝나면 점수만 봅니다.
          </p>
        </div>
      </section>
      <section className="mx-auto max-w-6xl px-4 py-8">
        <div className="mb-6 grid gap-4 rounded-md border bg-muted/20 p-4 text-sm leading-7 text-muted-foreground md:grid-cols-3" data-play-format-note>
          <div>
            <h2 className="text-base font-semibold tracking-normal text-foreground">누르면 시작</h2>
            <p className="mt-2">
              규칙은 화면 안에 짧게 나옵니다. 읽다가 지치게 만들 생각은 없습니다.
            </p>
          </div>
          <div>
            <h2 className="text-base font-semibold tracking-normal text-foreground">손맛 쪽으로</h2>
            <p className="mt-2">
              클릭, 드래그, 방향키, 스페이스처럼 바로 알아먹는 조작을 우선합니다.
            </p>
          </div>
          <div>
            <h2 className="text-base font-semibold tracking-normal text-foreground">끝나면 짧게</h2>
            <p className="mt-2">
              결과는 점수와 한 줄이면 충분합니다. 무슨 대단한 검사처럼 굴지는 않습니다.
            </p>
          </div>
        </div>
