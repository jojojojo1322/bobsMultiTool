...
const arcadeContextGuides = {
  ...
  memory: {
    title: "릴리스 램프 재생을 따라 누르는 기억 콘솔",
    firstLook: "재생중/입력 대기 상태 띠, 켜진 릴리스 램프, 아래 입력열, 다시 보기 버튼을 먼저 봅니다.",
    firstMove: "첫 움직임은 입력 대기가 켜진 뒤의 램프 입력입니다. 재생이 끝날 때까지 보고 같은 순서로 따라 누릅니다.",
    pacingText: "한 판은 짧은 릴리스 신호를 조금씩 늘리며 갑니다. 결과는 점수보다 기억 길이, 입력열, 첫 실수 위치로 남습니다.",
    recordText: "기록은 다음에 어떤 램프에서 흔들렸는지 알려주는 콘솔 로그입니다. 헷갈리면 다시 보기로 신호를 확인한 뒤 입력 대기에서 이어 누릅니다.",
  },
  flight: {
