...
const arcadeContextGuides = {
  ...
  flight: {
    title: "파란 덕트 틈과 붉은 배선을 먼저 보는 원버튼 비행판",
    firstLook: "점검 드론, 오른쪽에서 오는 파란 덕트 틈, 붉은 배선 뭉치, 누름/뗌 큐를 먼저 봅니다.",
    firstMove: "첫 움직임은 계속 누르기가 아니라 짧게 눌러 띄우고 손을 떼어 낮추는 것입니다. 덕트 틈 앞에서 높이를 맞춥니다.",
    pacingText: "한 판은 1분 덕트 비행으로 갑니다. 결과는 점수보다 누르고 떼는 리듬과 덕트 틈 통과로 남습니다.",
    recordText: "기록은 다음 덕트 틈 높이선을 더 빨리 읽기 위한 흔적입니다. 팬 바람을 과하게 타지 않고 배선을 피하는 감각만 남기면 됩니다.",
  },
  "brick-breaker": {
...
function playContextGuide(content: PlayContent): PlayContextGuide {
  if (content.type === "arcade-game") {
    const arcadeContextGuideOverrides: Partial<Record<string, Omit<PlayContextGuide, "kicker">>> = {
      ...
      "deploy-invaders": {
        title: "표식 침입자와 미끼 경고를 나누는 하단 방어포",
        ...
        pacingText: "한 판은 1분 고정포 방어입니다. 결과는 발사량보다 표식 침입자를 골라 차단한 흐름으로 남습니다.",
