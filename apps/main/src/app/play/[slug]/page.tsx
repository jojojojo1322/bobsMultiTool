...
const arcadeContextGuides = {
  ...
  crossing: {
    title: "노란 배포표를 한 칸씩 옮겨 초록칸만 건너는 차선 보드",
    firstLook: "노란 배포표, 아래 대기선, 차선 번호, 바로 앞 초록/노랑/빨강 칸, 위쪽 도착 슬롯을 먼저 봅니다.",
    firstMove: "첫 움직임은 전진보다 판단입니다. 바로 앞 칸이 위험하면 대기선에 머물고, 초록칸이 열리면 한 칸만 건넙니다.",
    pacingText: "한 판은 1분 릴리스 차선 건너기입니다. 결과는 빨리 간 정도보다 기다린 타이밍, 옆 칸 회피, 초록칸 판단으로 남습니다.",
