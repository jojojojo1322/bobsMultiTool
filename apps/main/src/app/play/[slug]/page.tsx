...
const arcadeContextGuides = {
  ...
  crossing: {
    title: "다음 배포칸의 위험을 보는 차선 판",
    firstLook: "배포 차선, 다음 배포칸 표시, 빈 차선, 릴리스선을 먼저 봅니다.",
    firstMove: "첫 움직임은 위로 달리기가 아니라 한 칸 이동입니다. 위험한 칸이면 멈춥니다.",
    pacingText: "한 판은 1분 배포 차선 건너기입니다. 결과는 빨리 간 정도보다 멈춘 타이밍과 빈틈 판단으로 남습니다.",
    recordText: "기록은 다음 배포 차선을 더 차분히 읽기 위한 흔적입니다. 부딪혔다면 속도보다 멈춤을 먼저 봅니다.",
  },
  minesweeper: {
