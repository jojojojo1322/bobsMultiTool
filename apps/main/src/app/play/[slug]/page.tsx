...
const arcadeContextGuides = {
  ...
  "match-three": {
    title: "색돌 한 수를 보는 맞추기 판",
    firstLook: "같은 색 셋이 될 수 있는 자리와 점선 힌트를 먼저 봅니다.",
    firstMove: "첫 움직임은 옆 칸 교환입니다. 눈에 띄는 돌보다 바로 셋이 되는 한 수를 고릅니다.",
    pacingText: "한 판은 짧게 이어집니다. 결과는 콤보 숫자보다 다음 한 수를 읽은 흔적으로 남습니다.",
    recordText: "기록은 색돌 흐름을 다시 보기 위한 메모입니다. 막히면 힌트를 보고 바로 다른 한 수를 시도합니다.",
  },
  memory: {
