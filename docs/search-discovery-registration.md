...
| WebSub | `https://pubsubhubbub.appspot.com/` for RSS and Atom topics | Latest publish responses `204`, `204` with feed item counts `138`, `138` after the play feedback development note | Feed update topics were accepted by the hub | It does not prove Google indexed the URLs |
