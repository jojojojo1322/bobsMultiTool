...
- The primary input/output surface should be visually isolated with `data-primary-work-area` and `data-primary-work-content`; support material should be grouped under `data-tool-support-sections` so related tools and examples do not visually attach to the immediate work area.
