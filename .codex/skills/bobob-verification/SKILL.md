...
- Play public copy and rendered Play screens should avoid action-count, move-limit, and count-toned wording such as "조작 횟수", "남은 횟수", or "몇 번 흔들림"; games should read as score, time, state, stage, or direct feedback instead. Endless lottery-style games should not show scoreboards, timers, move limits, or cumulative score labels.
