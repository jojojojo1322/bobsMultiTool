...
5. Ensure the tool metadata supports failure cases, pre-copy checklist, and related next actions through useCases, inputExamples, searchIntents, relatedTools, and localized labels.
