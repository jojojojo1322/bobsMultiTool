...
- Tool detail support prose is also common dictionary content. Failure cases, pre-copy checklist, and related next-action labels must be localized for every supported locale.
