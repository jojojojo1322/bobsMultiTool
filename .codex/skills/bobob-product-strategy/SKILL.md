...
- Use a 70/30 split for roadmap work: improve core tool detail quality first, then add new feature breadth. Core pages should expose registry-backed `inputExamples`, `useCases`, `failureCases`, `preCopyChecklist`, and related next actions so search visitors have reasons to stay, review, and continue.
