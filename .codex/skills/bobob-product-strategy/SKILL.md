...
- Use a 70/30 split for roadmap work: improve core tool detail quality first, then add new feature breadth. Core pages should expose failure cases, pre-copy checklist, and related next actions so search visitors have reasons to stay, review, and continue.
