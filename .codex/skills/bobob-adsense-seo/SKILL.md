...
- Use `measurementBacklog` and `measuredExportPlan` only to prioritize which core pages need Search Console/AdSense export coverage next. Do not rewrite public title/description copy from backlog alone.
